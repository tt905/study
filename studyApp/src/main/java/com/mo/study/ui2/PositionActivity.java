...
public class PositionActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.btn_cell_pos).setOnClickListener(this);
        findViewById(R.id.btn_wifi_pos).setOnClickListener(this);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()){
            ...
            case R.id.btn_gps_pos:
                requestGpsPosition();
                break;
            case R.id.btn_cell_pos:
                getCellTrackInfo();
                break;
            case R.id.btn_wifi_pos:
                getWiFiPosition();
                break;
    ...
    private void requestGpsPosition() {
        ...
        // 10秒一次，N米距离
        mLocationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, 10L, 3f, locationGpsListener);
